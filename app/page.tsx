...
const services = [
  {
    ...
    description: "We design brands people actually remember. Logos, colors, typography—the whole identity that makes you stand out in Lagos and beyond.",
  },
  {
    icon: Code,
    title: "Web Development",
    description: "Fast, beautiful websites that work. We build with React, Next.js, and whatever tech gets your business online properly.",
  },
  {
    icon: Sparkles,
  ...
  },
  {
    icon: Megaphone,
    title: "Marketing",
    description: "Getting people to notice you. Social media, content, ads—whatever it takes to put your brand in front of the right audience.",
  },
]
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground">
              Based in Lagos, we design brands and build websites for businesses that want to look good and work better. No fluff, just good design and solid code.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12 gap-4">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl font-bold">Recent Projects</h2>
            </div>
