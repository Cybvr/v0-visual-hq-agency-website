...
const BREAKDOWN: BreakdownItem[] = [
    { item: 'Discovery & Design', description: 'Requirements, wireframes, UI/UX', getAmount: (b) => Math.round(b * 0.125) },
    { item: 'Frontend Development', description: 'React/Next.js, responsive layouts', getAmount: (b) => Math.round(b * 0.30) },
    ...
    { item: 'Features Integration', description: 'Booking, blog, search', getAmount: (b) => Math.round(b * 0.10) },
    { item: 'Testing & QA', description: 'Quality assurance, bug fixes', getAmount: (b) => Math.round(b * 0.05) },
    { item: 'Deployment & Training', description: 'Setup, training, documentation', getAmount: (b) => Math.round(b * 0.025) },
];
        ...
        <div className="bg-gray-100 min-h-screen py-4 sm:py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
                ...
                <div className="p-6 sm:p-10 bg-gradient-to-br from-blue-50 to-white border-b-2 border-blue-200">
                    <h2 className="text-xl sm:text-2xl font-bold text-blue-800 mb-6 text-center">Choose Your Investment Level</h2>
                    
                    <div className="max-w-3xl mx-auto">
                        {/* Budget Display */}
                        <div className="text-center mb-8">
                            <div className="text-5xl sm:text-6xl font-extrabold text-blue-800 mb-2">
                                {formatCurrency(budget)}
                            </div>
                            <div className={`text-xl sm:text-2xl font-semibold ${tier.color} mb-1`}>
                                {tier.name} Package
                            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 sm:p-10 bg-gray-50 border-b-2 border-gray-200">
                    <div>
                        ...
                        <h3 className="text-xs uppercase text-gray-500 mt-5 mb-2 tracking-wider font-semibold">Project Duration</h3>
                ...
                <div className="p-6 sm:p-10">
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-start">
                                            ...
                                            <div className="flex-grow">
                                                <h3 className={`font-semibold text-sm sm:text-base mb-1 ${isUnlocked ? 'text-gray-900' : 'text-gray-500'}`}>
                                                    {feature.text}
                                                </h3>
                    ...
                    {/* Cost Breakdown */}
                    <div className="mb-8 sm:mb-12">
                        <h2 className="text-xl sm:text-2xl font-semibold text-blue-800 mb-4 pb-2 border-b-2 border-blue-800">Cost Breakdown</h2>
                            ...
                            <table className="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
                                <thead className="bg-blue-800">
                                    <tr>
                                        ...
                                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-white hidden md:table-cell">Description</th>
                                        <th className="px-4 sm:px-6 py-3 text-right text-xs sm:text-sm font-semibold text-white">Amount</th>
                                    </tr>
                                </thead>
                                <tbody className="bg-white divide-y divide-gray-100">
                                    {BREAKDOWN.map((item, index) => (
                                        <tr key={index} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-4 sm:px-6 py-3 text-xs sm:text-sm text-gray-500 hidden md:table-cell">{item.description}</td>
                                    ...
                                    <tr className="bg-blue-800 text-white">
                                        <td colSpan={2} className="px-4 sm:px-6 py-3 text-sm sm:text-lg font-bold">TOTAL INVESTMENT</td>
                                        <td className="px-4 sm:px-6 py-3 text-sm sm:text-lg font-bold text-right">{formatCurrency(totalBreakdown)}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div className="mb-8 sm:mb-12">
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col sm:flex-row border-l-4 border-blue-800 bg-gray-50 p-4 rounded-r-lg shadow-sm">
                                <div className="flex-shrink-0 sm:w-24 font-bold text-blue-800 mb-2 sm:mb-0 text-sm sm:text-base">Week 1</div>
                                <div className="text-gray-700 flex-grow text-sm sm:text-base">Requirements gathering, design mockups, database architecture, PAU brand integration</div>
                            </div>
                            <div className="flex flex-col sm:flex-row border-l-4 border-blue-800 bg-gray-50 p-4 rounded-r-lg shadow-sm">
                                <div className="flex-shrink-0 sm:w-24 font-bold text-blue-800 mb-2 sm:mb-0 text-sm sm:text-base">Week 2</div>
                                <div className="text-gray-700 flex-grow text-sm sm:text-base">Frontend development: UI components, public pages, catalog interface, responsive design</div>
                            </div>
                            <div className="flex flex-col sm:flex-row border-l-4 border-blue-800 bg-gray-50 p-4 rounded-r-lg shadow-sm">
                                <div className="flex-shrink-0 sm:w-24 font-bold text-blue-800 mb-2 sm:mb-0 text-sm sm:text-base">Week 3</div>
                                <div className="text-gray-700 flex-grow text-sm sm:text-base">Backend development: API, database, authentication, admin dashboard, search integration</div>
                            </div>
                            <div className="flex flex-col sm:flex-row border-l-4 border-blue-800 bg-gray-50 p-4 rounded-r-lg shadow-sm">
                                <div className="flex-shrink-0 sm:w-24 font-bold text-blue-800 mb-2 sm:mb-0 text-sm sm:text-base">Week 4</div>
                                <div className="text-gray-700 flex-grow text-sm sm:text-base">Testing, content migration, staff training, deployment, final review</div>
                            </div>
                            {duration > 4 && (
                                <div className="flex flex-col sm:flex-row border-l-4 border-blue-800 bg-gray-50 p-4 rounded-r-lg shadow-sm">
                                    <div className="flex-shrink-0 sm:w-24 font-bold text-blue-800 mb-2 sm:mb-0 text-sm sm:text-base">Weeks 5-{duration}</div>
                                    <div className="text-gray-700 flex-grow text-sm sm:text-base">Additional features implementation, extended testing, advanced integrations</div>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <footer className="p-6 text-center text-gray-600 text-xs sm:text-sm bg-gray-50">
                    <p className="font-bold">VisualHQ | Digital Solutions & Web Development</p>
                    <p className="mt-2">Valid until December 31, 2025 | All pricing in Nigerian Naira (₦)</p>
                </footer>
            </div>
