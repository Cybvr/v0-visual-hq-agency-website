...
function PostImage({ post }: { post: InstagramPost }) {
  return (
    <div className="relative h-full w-full bg-[#F2EFF4]">
      <Image
        src={post.image}
        alt={post.imageAlt}
        fill
    ...
    >
      ...
      >
        <div className="flex flex-shrink-0 items-center gap-3 border-b border-[#efefef] px-4 py-3 md:hidden">
          ...
          <span className="min-w-0 flex-1 truncate text-sm font-semibold">{BRAND.handle}</span>
          ...
          <div className="px-4 py-3 md:flex-1 md:overflow-y-auto">
            <div className="mb-4 flex gap-3">
              ...
              <div className="min-w-0 text-sm leading-snug">
                <span className="font-semibold">{BRAND.handle}</span> {post.caption}{" "}
...
export default function InstagramPreviewPage() {
  ...
  const previewPosts = instagramPosts.slice(0, PREVIEW_POST_COUNT);
    ...
    <div className="flex h-screen flex-col overflow-hidden bg-background px-3 py-4 text-foreground sm:px-5 md:py-8">
      ...
      <nav className="sticky top-0 hidden h-full max-h-[calc(100vh-170px)] w-[72px] flex-shrink-0 flex-col items-center border-r border-[#dbdbdb] py-2 pb-5 md:flex">
        ...
        <div className="flex flex-1 flex-col items-center gap-1.5">
          <a className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <Home size={24} strokeWidth={1.9} color="#000" />
          </a>
          <a className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <ShoppingBag size={24} strokeWidth={1.7} color="#000" />
          </a>
          <a className="relative flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <Send size={24} strokeWidth={1.8} color="#000" />
            <span className="absolute right-[5px] top-[5px] flex h-[17px] w-[17px] items-center justify-center rounded-full border-2 border-white bg-[#ff3040] text-[11px] font-bold text-white">
              8
            </span>
          </a>
          <a className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <Search size={24} strokeWidth={1.9} color="#000" />
          </a>
          <a className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <Compass size={24} strokeWidth={1.9} color="#000" />
          </a>
          <a className="relative flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <Heart size={24} strokeWidth={1.9} color="#000" />
            <span className="absolute right-[11px] top-2 h-2 w-2 rounded-full border-[1.5px] border-white bg-[#ff3040]" />
          </a>
          <a className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <SquarePlus size={24} strokeWidth={1.9} color="#000" />
          </a>
          <a className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <Clapperboard size={24} strokeWidth={1.9} color="#000" />
          </a>
          <a className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <span className="block h-[26px] w-[26px] rounded-full border-[1.5px] border-black bg-gradient-to-br from-[#7a4de0] to-[#c93a86]" />
          </a>
        </div>

        <div className="flex flex-col items-center gap-1.5">
          <a className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <Menu size={24} strokeWidth={1.9} color="#000" />
          </a>
          <a className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl hover:bg-[#f2f2f2]">
            <Grid2x2 size={24} strokeWidth={1.9} color="#000" />
          </a>
        </div>
      </nav>
      ...
      <nav className="sticky top-0 z-40 flex w-full items-center justify-between border-b border-[#dbdbdb] bg-white px-4 py-3 md:hidden">
        ...
        <div className="flex items-center gap-5">
          ...
          <a className="relative">
            <Heart size={24} strokeWidth={1.8} color="#000" />
            <span className="absolute right-[-3px] top-[-3px] h-2 w-2 rounded-full border border-white bg-[#ff3040]" />
          </a>
      ...
      <div className="flex min-w-0 flex-1 flex-col pb-16 md:pb-0">
        <main className="mx-auto w-full max-w-[935px] flex-1 px-3 pt-4 sm:px-5 md:pt-[30px]">
          <header className="px-2 pb-6 sm:px-5 sm:pb-11 md:flex md:gap-[52px]">
            <div className="flex items-center gap-5 md:block md:h-[168px] md:w-[168px] md:flex-shrink-0">
              ...
              <div className="flex min-w-0 flex-1 items-center gap-1.5 md:hidden">
                <span className="truncate text-lg font-normal text-[#262626]">{BRAND.handle}</span>
            ...
            <div className="mt-4 min-w-0 md:mt-0 md:flex-1 md:pt-1.5">
              <div className="mb-5 hidden flex-wrap items-center gap-2 md:flex">
                <span className="text-xl font-normal text-[#262626]">{BRAND.handle}</span>
                <BadgeCheck size={18} fill="#3897f0" stroke="#fff" strokeWidth={2} />
                <div className="ml-3 flex gap-2">
                  <button className="rounded-lg bg-[#efefef] px-4 py-2 text-sm font-semibold text-[#262626]">
                    Following v
                  </button>
                  <button className="rounded-lg bg-[#efefef] px-4 py-2 text-sm font-semibold text-[#262626]">
                    Message
                  </button>
                  <button className="rounded-lg bg-[#efefef] px-3 py-2 text-sm font-semibold text-[#262626]">
                    v
                  </button>
                </div>
              </div>
              ...
              <div className="mb-4 flex justify-around border-y border-[#dbdbdb] py-3 text-center md:hidden">
                <div>
                  <div className="text-base font-semibold text-[#262626]">{instagramPosts.length}</div>
                  <div className="text-xs text-[#8e8e8e]">posts</div>
                </div>
                <div className="cursor-pointer">
                  <div className="text-base font-semibold text-[#262626]">{BRAND.followers}</div>
                  <div className="text-xs text-[#8e8e8e]">followers</div>
                </div>
                <div className="cursor-pointer">
                  <div className="text-base font-semibold text-[#262626]">{BRAND.following}</div>
                  <div className="text-xs text-[#8e8e8e]">following</div>
                </div>
              </div>

              <div className="mb-5 hidden gap-10 md:flex">
                <span className="text-base text-[#262626]">
                  <b className="font-semibold">{instagramPosts.length}</b> posts
                </span>
                <span className="cursor-pointer text-base text-[#262626]">
                  <b className="font-semibold">{BRAND.followers}</b> followers
                </span>
                <span className="cursor-pointer text-base text-[#262626]">
                  <b className="font-semibold">{BRAND.following}</b> following
                </span>
              </div>

              <div className="max-w-[520px] px-2 text-sm leading-normal text-[#262626] sm:px-0">
                <div className="font-semibold">{BRAND.name}</div>
                <div className="mb-px text-[#737373]">{BRAND.category}</div>
                <div>{BRAND.blurb}</div>
                <div className="mt-0.5">{BRAND.tagline}</div>
                <a
                  href="#"
                  className="mt-1 inline-flex items-center gap-1.5 font-semibold text-[#00376b] no-underline"
                >
              ...
              <div className="mt-4 flex gap-2 px-2 sm:px-0 md:hidden">
                <button className="flex-1 rounded-lg bg-[#efefef] px-4 py-2 text-sm font-semibold text-[#262626]">
                  Following v
                </button>
                <button className="flex-1 rounded-lg bg-[#efefef] px-4 py-2 text-sm font-semibold text-[#262626]">
                  Message
          ...
          <div className="grid grid-cols-1 gap-1 sm:grid-cols-3">
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[440px] bg-gradient-to-b from-white/0 via-white/85 to-white sm:h-[52%] sm:via-white/72" />
          </div>
      ...
      <nav className="sticky bottom-0 z-40 flex items-center justify-around border-t border-[#dbdbdb] bg-white py-2.5 md:hidden">
        <a className="flex h-9 w-9 items-center justify-center">
          <Home size={24} strokeWidth={1.9} color="#000" />
        </a>
        <a className="flex h-9 w-9 items-center justify-center">
          <Search size={24} strokeWidth={1.9} color="#000" />
        </a>
        <a className="flex h-9 w-9 items-center justify-center rounded-lg border-[1.5px] border-black">
          <SquarePlus size={20} strokeWidth={1.9} color="#000" />
        </a>
        <a className="flex h-9 w-9 items-center justify-center">
          <Clapperboard size={24} strokeWidth={1.9} color="#000" />
        </a>
        <a className="flex h-9 w-9 items-center justify-center">
          <span className="block h-6 w-6 rounded-full border-[1.5px] border-[#321A42] bg-gradient-to-br from-[#7a4de0] to-[#c93a86]" />
        </a>
      </nav>

      <div className="absolute bottom-[22px] right-6 hidden items-center gap-3.5 rounded-full border border-[#dbdbdb] bg-white py-2.5 pl-[18px] pr-4 shadow-[0_4px_16px_rgba(0,0,0,0.12)] md:flex">
        <div className="relative flex items-center gap-2.5">
          <Send size={22} strokeWidth={1.8} color="#000" />
          <span className="absolute -top-1 left-2.5 flex h-[15px] w-[15px] items-center justify-center rounded-full border-2 border-white bg-[#ff3040] text-[10px] font-bold text-white">
            8
          </span>
          <span className="text-[15px] font-semibold text-[#262626]">Messages</span>
        </div>
        <div className="flex items-center">
          <span className="h-[26px] w-[26px] rounded-full border-2 border-white bg-gradient-to-br from-[#e0863a] to-[#c93a86]" />
          <span className="-ml-2 h-[26px] w-[26px] rounded-full border-2 border-white bg-gradient-to-br from-[#7a4de0] to-[#3a86c9]" />
          <span className="-ml-2 h-[26px] w-[26px] rounded-full border-2 border-white bg-[#2a2a2a]" />
          <span className="ml-1.5 font-bold text-[#262626]">...</span>
        </div>
      </div>

      {openIndex !== null && (
        <PostModal
          post={instagramPosts[openIndex]}
