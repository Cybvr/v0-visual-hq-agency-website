...
export const featuredDeal: FeaturedDeal = {
  badge: "Active Deal",
  name: "Project Neon - Platform LBO",
  sector: "Sector: Fintech / SaaS Infrastructure",
  ev: "$420M",
  evLabel: "EV Estimate",
  image:
